...
public partial class CiPlatformDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:constr1");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141DEE271B5");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8283CAAC3");
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("FK__city__country_id__3B40CD36");
        });

        modelBuilder.Entity<CmsPage>(entity =>
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B527E086BC4");
        ...
        modelBuilder.Entity<ContactU>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.ContactUs)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK_Contact_us_users");
        });

        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD05521D82638");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CAB9B24FB6");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867184AC02F");
